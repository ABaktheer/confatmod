...
print 'N_mi ', N_mi
print 'N_mi.shape ', N_mi.shape
print 'dN_mei', dN_mei
print 'dN_mei.shape', dN_mei.shape
print '*************************'
...
print 'n_e_dof ', n_e_dof
print 'n_n_tot ', n_n_tot
print 'n_dof_tot ', n_dof_tot
print '*************************'
...
print 'I_Ei ', I_Ei
print 'x_Eid ', x_Eid
print 'x_Eid.shape', x_Eid.shape
print '*************************'
print 'J_Emde ', J_Emde
print 'J_det_Em  ', J_det_Em
print 'J_inv_Emed', J_inv_Emed
print '*************************'
...
print 'dN_Eimd', dN_Eimd
print 'BB_ECidDjf', BB_ECidDjf
print 'NN_ECidDjf', NN_ECidDjf
print 'BB_Eij', BB_Eij
print 'NN_Eij', NN_Eij
print '*************************'
