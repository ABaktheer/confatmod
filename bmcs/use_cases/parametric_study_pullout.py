...
from matmod.mats_bondslip_fatigue import MATSEvalFatigue
...
class UCPStudyElement(BMCSTreeNode):
    ...
    linewidth = Trait('medium', dict(thin=0.5,
                                     medium=1.0,
                                     thik=2.0,
                                     )
                      )
    ...
    def plot(self, fig):
        ...
        self.content.plot(fig, color=self.color_, linestyle=self.linestyle_, linewidth=self.linewidth_,
                          label=self.node_name)

    def plot_ax(self, ax1, ax2, ax3, ax4):
        self.content.plot_custom(ax1=ax1, ax2=ax2, ax3=ax3, ax4=ax4, color=self.color_, linestyle=self.linestyle_, linewidth=self.linewidth_,
                                 label=self.node_name)
