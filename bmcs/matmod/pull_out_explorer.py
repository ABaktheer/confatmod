...
from bmcs.ibvpy.api import BCDof
...
model = PullOutSimulation(
    mats_eval=ts.mats_eval, fets_eval=ts.fets_eval, time_stepper=ts, time_loop=tl, geometry=geometry, loading_scenario=loading_scenario)
