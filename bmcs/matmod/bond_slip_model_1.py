...
class BondSlipModel(BMCSTreeNode):
    ...
    def plot(self, figure):  # , color='blue', linestyle='-',
        ...
        self.mats_eval.tau_bar = self.material.tau_bar
        ...
        tau_arr, tau_arr_e, w_arr = self.mats_eval.get_bond_slip(
            s_arr)

        ax1 = figure.add_subplot(221)
        ax1.cla()
        ax1.plot(s_arr, tau_arr, label='Plastic-Damage')
        ax1.plot(s_arr, tau_arr_e, '--k', label='Elastic-Plastic')
...
#         ax3.plot(s_arr, w_arr, lw=linewidth, color=color,
