...
# S=0.5
s_05 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_05_2_s.txt')
t_05 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_05_2_t.txt')


# S=2.0
s_2 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_2_1_s.txt')
t_2 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_2_1_t.txt')
...
# S=8.0
s_8 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_8_1_s.txt')
t_8 = np.loadtxt( r'H:\Heimarbeit\DFG_ComFatiCon\SLIDE\SLIDE_calibration\Cyclic_Verndermonde\data\ts_8_1_t.txt')
