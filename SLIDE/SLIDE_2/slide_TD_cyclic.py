...
if __name__ == '__main__':
    ...
    n = 1000
    s_levels = linspace(0,  0.0006, 50)
    s_levels[0] = 0
    s_levels.reshape(-1, 2)[:, 0] *= -1
    s_history_1 = s_levels.flatten()

    s_levels = linspace(0,  0.0006, 2)
    s_levels[0] = 0
    s_levels.reshape(-1, 2)[:, 0] *= -1
    ...
    s_arr_1, sigma_arr_1, eps_N_p_arr_1, w_N_arr_1 = get_CP_TD_Law(
        s_arr_1, sigma_0=15, K=1000.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=20000, m=0.0, a=0.0)
    s_arr_2, sigma_arr_2, eps_N_p_arr_2, w_N_arr_2 = get_CP_TD_Law(
        s_arr_2, sigma_0=15, K=1000.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=20000, m=0.0, a=0.0)
    s_arr_3, sigma_arr_3, eps_N_p_arr_3, w_N_arr_3 = get_CP_TD_Law(
        s_arr_3, sigma_0=15, K=1000.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=20000, m=0.0, a=0.0)

    ax2 = plt.subplot(231)
    ax2.plot(s_arr_1, sigma_arr_1, color='k', label='Ad=20000')
    ax2.plot(s_arr_2, sigma_arr_2, color='r', label='Ad=20000')
    ax2.plot(s_arr_3, sigma_arr_3, color='r', label='Ad=20000') 
    ...
    ax2.plot(s_arr_2, w_N_arr_2, color='r', label='Ad=20000')
    ax2.plot(s_arr_3, w_N_arr_3, color='r', label='Ad=20000')
    ...
    ax2 = plt.subplot(233)
    ax2.plot(s_arr_1, eps_N_p_arr_1, color='k', label='Ad=20000')
    ax2.plot(s_arr_2, eps_N_p_arr_2, color='r', label='Ad=20000')
    ax2.plot(s_arr_3, eps_N_p_arr_3, color='r', label='Ad=20000')
