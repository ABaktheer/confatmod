...
#=========================
etas = np.loadtxt(
    r'H:\Heimarbeit\results_random\1500 samples\etas.txt')
DS = np.loadtxt(
    r'H:\Heimarbeit\results_random\1500 samples\DS.txt')
abs_DS = np.loadtxt(
    r'H:\Heimarbeit\results_random\1500 samples\abs_DS.txt')
Sm = np.loadtxt(
    r'H:\Heimarbeit\results_random\1500 samples\Sm.txt')


Smax_mean = np.loadtxt(r'H:\Heimarbeit\results_random\1500 samples\Smax_mean.txt')
eta_mean = np.loadtxt(r'H:\Heimarbeit\results_random\1500 samples\eta_mean.txt')
