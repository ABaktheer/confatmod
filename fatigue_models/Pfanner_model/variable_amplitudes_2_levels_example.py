...
class Pfanner_fatigue_model():
    ...
    def get_N_2(self, D, sig_max, sig_min, T, leq, Gcl, Ec, fc, eps_c, b, xci_c, inc, N_0):
        ...
        d = self.get_fatigue_response(
            N_max, sig_max, sig_min, T, leq, Gcl, Ec, fc, eps_c, b, xci_c, 10, N_0)
...
#     N_2 = 320
    ...
    D_1 = P.get_fatigue_response(
        N,  sig_max_1, sig_min_1, 0.1, 0.25, 0.03, 50300.0, fc, 0.003, 0.2, 0.2, inc, 100)
    D_2 = P.get_fatigue_response(
        N,  sig_max_2, sig_min_1, 0.1, 0.25, 0.03, 50300.0, fc, 0.003, 0.2, 0.2, inc, 10000)
    ...
    plt.plot(d_des[2][1:], d_des[3][1:], 'b')
    #plt.plot(D_1[0][1:], D_1[1][1:], '--k')
    #plt.plot(D_2[0][1:], D_2[1][1:], ':k')
#
#     plt.xlabel('N')
