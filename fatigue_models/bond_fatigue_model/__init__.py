...
def get_bond_slip(s_arr, tau_pi_bar, K, gamma, E_b, S, c, r, a, sigma_n):
    ...
    for i in range(1, len(s_arr)):
        ...
        # Threshold
        f_pi_i = np.fabs(tau_i_1 - X_i) - tau_pi_bar - Z + a * sigma_n / 3
        ...
        if f_pi_i > 1e-6:
            ...
            diss_i += (tau_pi_bar - a * sigma_n / 3) * delta_lamda + \
...
if __name__ == '__main__':
    ...
    s_arr_2 = np.hstack([np.linspace(s_history[i], s_history[i + 1], 50)
    ...
    s_arr_1, tau_arr_1, w_arr_1, s_pi_arr_1, s_max_1, tau_max_1, s_pi_cum_1, diss_1 = get_bond_slip(
        s_arr_1, tau_pi_bar=5, K=0, gamma=100, E_b=1000, S=.05, c=1, r=1.0, a=1.7, sigma_n=0)

    s_arr_2, tau_arr_2, w_arr_2, s_pi_arr_2, s_max_2, tau_max_2, s_pi_cum_2, diss_2 = get_bond_slip(
        s_arr_2, tau_pi_bar=5, K=0, gamma=100, E_b=1000, S=.05, c=1, r=1.0, a=1.7, sigma_n=0)

    s_arr_3, tau_arr_3, w_arr_3, s_pi_arr_3, s_max_3, tau_max_3, s_pi_cum_3, diss_3 = get_bond_slip(
        s_arr_3, tau_pi_bar=5, K=0, gamma=100, E_b=1000, S=.05, c=1, r=1.0, a=1.7, sigma_n=0)

    s_arr_4, tau_arr_4, w_arr_4, s_pi_arr_4, s_max_4, tau_max_4, s_pi_cum_4, diss_4 = get_bond_slip(
        s_arr_4, tau_pi_bar=5, K=0, gamma=100, E_b=1000, S=.05, c=1, r=1.0, a=1.7, sigma_n=0)
    ...
    ax1.plot(s_arr_4, tau_arr_4, 'g', linewidth=1.5,
             label='$ \sigma_N = 20$ MPa')
    ...
    ax2.plot(s_arr_3, w_arr_3, 'g', linewidth=1.5,
             label='$ \sigma_N = 20$ MPa')
    ax2.plot(s_arr_4, w_arr_4, 'g', linewidth=1.5,
             label='$ \sigma_N = 20$ MPa')
    ...
    plt.plot(s_pi_cum_3, w_arr_3, 'g', linewidth=1.5,
             label='$ \sigma_N = 20$ MPa')
    plt.plot(s_pi_cum_4, w_arr_4, 'g', linewidth=1.5,
             label='$ \sigma_N = 20$ MPa')
