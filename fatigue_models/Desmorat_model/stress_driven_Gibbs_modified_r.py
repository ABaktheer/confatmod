...
#================================================
    ...
    ax4.plot(t_arr[0:5000], sig_arr_1[0:5000], 'k', linewidth=1,
             label='$ \sigma_N = 0$ MPa', alpha=1)
