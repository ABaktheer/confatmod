...
def get_strain_stress(sig_arr, sig_0, E1, E2, K, gamma, S):
...
if __name__ == '__main__':
    ...
    sig_arr_1 = np.hstack([np.linspace(s_history[i], s_history[i + 1], 10000)
    ...
    eps_arr_1, sig_arr_1, w_arr_1, eps_pi_arr_1, eps_pi_cum_1, i1 = get_strain_stress(
        sig_arr_1, sig_0=9., E1=20000., E2=15000., K=0., gamma=0., S=0.000324)
    eps_arr_2, sig_arr_2, w_arr_2, eps_pi_arr_2, eps_pi_cum_2, i2 = get_strain_stress(
...
# saving results
    ...
    np.savetxt(r'E:\Publishing\Educative_fatigue_Article\results\Desmorat\saved\eps_arr.txt',
               eps_arr_2[0:i2], delimiter=" ", fmt="%s")
    np.savetxt(r'E:\Publishing\Educative_fatigue_Article\results\Desmorat\saved\sig_arr.txt',
               sig_arr_2[0:i2], delimiter=" ", fmt="%s")
    np.savetxt(r'E:\Publishing\Educative_fatigue_Article\results\Desmorat\saved\w_arr.txt',
