...
from numpy import \
    array, zeros, trace, \
    einsum, zeros_like,\
    identity, sign, linspace, hstack, sqrt
...
class MATSEvalMicroplaneFatigue(HasTraits):
    ...
    def get_normal_Law(self, eps, sctx):
        ...
        # Extract the dissipation components
...
if __name__ == '__main__':
    ...
    s_levels = linspace(0, -0.002, 20)
    s_levels.reshape(-1, 2)[:, 1] = -0.0023
