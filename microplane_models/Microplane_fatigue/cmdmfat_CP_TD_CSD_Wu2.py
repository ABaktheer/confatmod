...
if __name__ == '__main__':
    ...
    s_levels_1 = linspace(-0.001, -0.012, 40)
    s_levels_2 = linspace(-0.00015, -0.005, 40)
    s_levels_1[0] = 0
    s_levels_1.reshape(-1, 2)[:, 0] = s_levels_2.reshape(-1, 2)[:, 1] * 1.5
    s_levels_1.reshape(-1, 2)[:, 1] = s_levels_1.reshape(-1, 2)[:, 1] * 1.0
    s_levels_1[0] = 0
    #s_levels.reshape(-1, 2)[:, 1] = -0.0015
...
#     s_arr_2 = hstack([linspace(s_history_2[i], s_history_2[i + 1], 20)
...
#         eps_Pi_T_1[i, :, :] = sctx_1[i, :, 10:13]
#
#         if sigma_1[i, 0, 0] >= abs(30):
#             eps_1[i + 1, :] = eps_1[i, 0, 0] - 0.01
#             if sigma_1[i, 0, 0]
#         else:
#             eps_1[i + 1, :] = eps_1[i, 0, 0] + 0.01
