...
if __name__ == '__main__':
    ...
    s_arr_1, sigma_arr_1, eps_N_p_arr_1, w_N_arr_1 = get_CP_TD_Law(
        s_arr_1, sigma_0=20, K=150.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=5000, m=-0.0, a=0.0001)
    s_arr_2, sigma_arr_2, eps_N_p_arr_2, w_N_arr_2 = get_CP_TD_Law(
        s_arr_2, sigma_0=20, K=150.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=5000, m=-0.4, a=0.0001)
    s_arr_3, sigma_arr_3, eps_N_p_arr_3, w_N_arr_3 = get_CP_TD_Law(
        s_arr_3, sigma_0=20, K=150.0, gamma=1000.0, E=34000, eps_0=1.0e-4, Ad=5000, m=-0.6, a=0.0001)

    ax2 = plt.subplot(111)
    ax2.plot(s_arr_1, sigma_arr_1, color='k')
    ax2.plot(s_arr_2, sigma_arr_2, color='r')
    ax2.plot(s_arr_3, sigma_arr_3, color='g')
