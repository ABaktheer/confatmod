...
if __name__ == '__main__':
    ...
    s_arr_1, tau_arr_1, w_arr_1, xs_pi_arr_1 = get_CSD_Law(
        s_arr_1, tau_pi_bar=5., K=300000, gamma=100000., G=30000., S=0.000002, c=2.0, r=1.0, a=0.0, sigma_n=0.0, m=0.0)

    s_arr_2, tau_arr_2, w_arr_2, xs_pi_arr_2 = get_CSD_Law(
        s_arr_2, tau_pi_bar=5., K=300000, gamma=100000., G=30000., S=0.000002, c=2.0, r=1.0, a=0.0, sigma_n=0.0, m=0.0)

    s_arr_3, tau_arr_3, w_arr_3, xs_pi_arr_3 = get_CSD_Law(
        s_arr_3, tau_pi_bar=5., K=300000, gamma=100000., G=30000., S=0.000002, c=2.0, r=1.0, a=0.0, sigma_n=0.0, m=0.0)

    ax2 = plt.subplot(231)
    ax2.plot(s_arr_1, tau_arr_1, color='k', label='a')
    ax2.plot(s_arr_2, tau_arr_2, color='r', label='b')
    ax2.plot(s_arr_3, tau_arr_3, color='k')
    ...
    ax2.plot(s_arr_3, w_arr_3, color='k')
    ax2.axhline(y=0, color='k', linewidth=1, alpha=0.5)
    ax2.axvline(x=0, color='k', linewidth=1, alpha=0.5)
    plt.title('Normal behavior (CP,TD) - monotonic')
    plt.xlabel('strain')
