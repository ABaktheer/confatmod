...
class MATSXDMicroplaneDamageFatigue(MATSEvalMicroplaneFatigue):
    ...
    def get_corr_pred(self, sctx, eps_app_eng, sigma_kk):
        ...
        #print('beta_ijkl', beta_ijkl.shape)
        #print('self.D4_e', self.D4_e.shape)
...
class MATS3DMicroplaneDamage(MATSXDMicroplaneDamageFatigue):
...
if __name__ == '__main__':
    ...
    n = 50
    s_levels = linspace(0, 0.05, 100)

    s_levels.reshape(-1, 2)[:, 0] = 0.0005
    s_levels[0] = 0
    s_levels.reshape(-1, 2)[:, 1] = 0.004
