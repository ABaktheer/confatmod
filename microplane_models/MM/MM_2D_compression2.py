...
#     ===================================================='''
    ...
    for i in range(0, n_mp):
        plt.plot(
            -eps_1[:, 0, 0], -eps_N_1[:, i], color='black', linewidth=1.0, label='cyclic', alpha=1)
    ...
    for i in range(0, n_mp):
        plt.plot(
            -eps_1[:, 0, 0], w_N_1[:, i], color='black', linewidth=1.0, label='cyclic', alpha=1)
    ...
    for i in range(0, n_mp):
        plt.plot(
            -eps_1[:, 0, 0], z_N_1[:, i], color='black', linewidth=1.0, label='cyclic', alpha=1)
    ...
    for i in range(0, n_mp):
        plt.plot(
            -eps_1[:, 0, 0], eps_P_N_1[:, i], color='black', linewidth=1.0, label='cyclic', alpha=1)
