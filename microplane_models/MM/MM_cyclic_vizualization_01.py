...
#========================================================================
# Vizualizations of the microplanes damage
#========================================================================
...
#===================================================================
#     filename6 = os.path.join(out_path, 'colorbar_red' + '.pdf')
...
#===================================================================
    ...
    for i in peaks:  # loop over the minima and maxima at cyclic loading
        ...
        f_pipe3 = m.points3d(normals2[idx[:], 0], normals2[idx[:], 1],
                             origin_coord[idx[:], 2], value[idx[:]
                                                            ].reshape(1, 28),
                             colormap='Reds', mode='sphere', resolution=100,
                             scale_factor=0.15 * factor, scale_mode='none')
        ...
        f_pipe3 = m.points3d(normals2[idx[:], 0], origin_coord[idx[:], 1],
                             normals2[idx[:], 2], value[idx[:]].reshape(1, 28),
                             colormap='Reds', mode='sphere', resolution=100,
                             scale_factor=0.15 * factor, scale_mode='none')
