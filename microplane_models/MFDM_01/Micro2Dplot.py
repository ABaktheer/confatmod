...
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 20)], linewidth=2.5)
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 15)], linewidth=2.5)
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 10)], linewidth=2.5)
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 8)], linewidth=2.5)
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 6)], linewidth=2.5)
# #         plt.plot(np.abs(F[A, 0]), sigma_N[A, np.int(n_mp / 5)], linewidth=2.5)
...
#         plt.plot(np.arange(len(A)), omegaT[A, np.int(n_mp / 9)], linewidth=2.5)
#         plt.plot(np.arange(len(A)),
#                  omegaT[A, np.int(n_mp / 10)], linewidth=2.5)
#         plt.plot(np.arange(len(A)),
#                  omegaT[A, np.int(n_mp / 11)], linewidth=2.5)
#
#
# #         plt.plot(np.abs(F[A, 0]), omegaT[A, np.int(n_mp / 8)], linewidth=2.5)
