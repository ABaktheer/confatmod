...
#
#=============================================
''' PSP 1000 - Test CT_120_1_18'''
#=============================================
home_dir = os.path.expanduser('~')
path = os.path.join(home_dir, 'Data Processing')
path = os.path.join(path, 'CT')
path = os.path.join(path, 'C120')
path = os.path.join(path, 'CT_120_1_18_LS3')

N_max_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Creep_n_load_max.npy'))
S_max_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Creep_displacement_max2.npy'))
SS_max_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Creep_displacement_max3.npy'))
SSS_max_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Creep_displacement_max4.npy'))

u_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Displacement2.npy'))
uu_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Displacement3.npy'))
uuu_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Displacement4.npy'))
F_1 = np.load(os.path.join(
    path, 'CT_120_1_18_LS3_Force.npy'))
...
path = os.path.join(path, 'CT')
path = os.path.join(path, 'C120')
path = os.path.join(path, 'CT_120_1_19_LS3')

N_max_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Creep_n_load_max.npy'))
S_max_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Creep_displacement_max2.npy'))
SS_max_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Creep_displacement_max3.npy'))
SSS_max_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Creep_displacement_max4.npy'))

u_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Displacement2.npy'))
uu_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Displacement3.npy'))
uuu_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Displacement4.npy'))
F_2 = np.load(os.path.join(
    path, 'CT_120_1_19_LS3_Force.npy'))
